# OnlyPorn Hardening Phase 0 — v2.6.3
...
## v2.6.2 compatibility

This restoration is layered on the production-verified v2.6.2 JAVHDPorn `vdcdn.xyz` hotfix. The host approval, custom token preservation, raw `.webp` MPEG-TS normalization, and existing PNG-wrapper decoding remain active. The three decoding layers are unchanged.
