...
const requiredFiles = [
  ...
  'provider/content-filter.js',
  'provider/content-filter.test.js',
  'provider/tpb4k-studio-metadata.test.js',
  'provider/tpb4k-phase2-final-cleanup.test.js',
  'provider/tpb4k.js',
  ...
  'provider/tpb4k/studio-metadata.js',
  'provider/tpb4k/sukebei-metadata.js',
  'provider/rd-catalog-sqlite.js',
  'provider/rd-catalog-sqlite.test.js',
  'provider/tpb4k/platform-hybrid.js',
  ...
  'TPB4K_METADATA_FIRST_FILTERS.md',
  'TPB4K_PHASE2_FINAL_CLEANUP.md',
  'DEPLOY_TPB4K_METADATA_FIRST_FILTERS.md',
  'DEPLOY_TPB4K_PHASE2_FINAL_CLEANUP.md',
  'DEPLOY_TPB4K_POSTER_ENRICHMENT.md',
  'RD_CATALOG_PERSISTENCE.md',
  ...
  'scripts/tpb4k-metadata-first-smoke.js',
  'scripts/tpb4k-sukebei-smoke.js',
  'scripts/import-rd-catalog-report.js',
  'scripts/inspect-rd-catalog.js',
  'scripts/rd-catalog-sqlite-worker.py',
  'scripts/warm-rd-metatube-posters.js',
